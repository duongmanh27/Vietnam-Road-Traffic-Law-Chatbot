    ...
    try {
        ...
        if (window.USE_MOCK) {
            ...
            if (imageToSend) {
                ...
                response = await fetch('https://centuried-operosely-delora.ngrok-free.dev/answer_with_image_input', {
                    method: 'POST',
                    headers: {
                ...
                response = await fetch('https://centuried-operosely-delora.ngrok-free.dev/chat_stream', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'ngrok-skip-browser-warning': 'true'
