...
async function fetchSystemStatsAPI() {
    ...
    try {
        const response = await fetch('https://centuried-operosely-delora.ngrok-free.dev/get_system_stats', {
            method: 'GET',
            headers: {
    ...
    importBtn.addEventListener('click', async () => {
        ...
        try {
            progressInterval = setInterval(async () => {
                try {
                    const res = await fetch('https://centuried-operosely-delora.ngrok-free.dev/check_progress', {
                        headers: {
                            'ngrok-skip-browser-warning': 'true'
                        }
                    });
            ...
            const response = await fetch('https://centuried-operosely-delora.ngrok-free.dev/process_folder_and_build', {
                method: 'POST',
                headers: {
                    'ngrok-skip-browser-warning': 'true'
                },
...
async function executeDeleteDoc() {
    ...
    try {
        ...
        const response = await fetch('https://centuried-operosely-delora.ngrok-free.dev/delete_document', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
